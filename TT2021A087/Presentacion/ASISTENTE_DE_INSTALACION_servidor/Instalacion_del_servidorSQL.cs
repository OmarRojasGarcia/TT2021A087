...
namespace TT2021A087.Presentacion.ASISTENTE_DE_INSTALACION_servidor
{
    public partial class Instalacion_del_servidorSQL : Form
    {
        ...
        private void Reemplazar()
        {
            ...
            txtCrear_procedimientos.Text = txtCrear_procedimientos.Text.Replace("BASETTPOS2021A087", TXTbasededatos.Text);
            //********

            txtEliminarBase.Text = txtEliminarBase.Text.Replace("BASETTPOS2021A087", TXTbasededatos.Text);          
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("pruebas2020", txtusuario.Text);
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("BASETTPOS2021A087", TXTbasededatos.Text);
            txtCrearUsuarioDb.Text = txtCrearUsuarioDb.Text.Replace("pruebas123", lblcontraseña.Text);
