...
namespace TT2021A087.Presentacion.Conexion_remota
{
    public partial class Conexion_secundaria : Form
    {
        ...
        private void conectar_manualmente()
        {
            ...
            cadena_de_conexion = "Data Source =" + IP + ";Initial Catalog=BASETTPOS2021A087;Integrated Security=False;User Id=pruebas2020;Password=pruebas123";
            comprobar_conexion();
