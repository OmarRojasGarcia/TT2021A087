    ...
    public partial class CierreTurno : Form
    {
       ...
       private void mostrarCorreoBase()
        ...
        private void cerrarCaja()
        {
            ...
            CIERRE_DE_CAJA.avisoCargo =   parametros.Total_real - parametros.Total_calculado;
        ...
        private void enviarcorreo()
        {
            if (checkCorreo.Checked==true)
            {
                ReemplazarHtml();
                bool estado;
                estado = Bases.enviarCorreo(correobase, contraseña, htmldeEnvio.Text, "Cierre de caja", txtcorreo.Text, "");
                if (estado == true)
                {
        ...
        public void ReemplazarHtml()
        {
            ...
            //generar una diferencia entre @fondo inicial - cierre de caja htmldeEnvio.Text = htmldeEnvio.Text.Replace("@avisodecargo", avisodecargo.saldorestado.ToString());
            htmldeEnvio.Text = htmldeEnvio.Text.Replace("@avisoCargo", CIERRE_DE_CAJA.avisoCargo.ToString());
