...
namespace TT2021A087.Presentacion

{
...

    {
        ...
        private void aperturar_detalle_de_cierre_caja()
        {
            ...
            cmd.Parameters.AddWithValue("@id_caja", 1 );//se deja por defecto al idcaja 1 
        ...
        private void Iniciar_sesion_correcto()
        {
          ...
          if (contador > 0)
            ...
            {
                MessageBox.Show("La contraseña capturada es incorrecta, favor de validar", "Contraseña incorrecta", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void mostrar_usuarios_por_correo()
        {
            try
            {
              ...
              SqlCommand   da = new SqlCommand ("buscar_USUARIO_por_correo", con);
                ...
                con.Open();
                lblResultadoContraseña.Text  = Bases.Desencriptar(Convert.ToString (da.ExecuteScalar()));
                con.Close();
        ...
        private void enviarCorreo()
        {
            ...
            Bases.enviarCorreo(correobase, contraseña, richTextBox1.Text, "Solicitud de Contraseña",  txtcorreo.Text, "");
            MessageBox.Show("Se ha enviado la contraseña al correo seleccionado");
