                ...
                try
                {
                    if (efectivo > total)
                    {
                        ...
                        else
                        {
                            ...
                            efectivo_entrante = efectivo - vuelto;
                        }
 ...
 reportViewer1.Focus();
        ...
        void CONFIRMAR_VENTA_EFECTIVO()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Efectivo", efectivo_entrante);
