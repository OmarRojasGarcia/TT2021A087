...
namespace TT2021A087.Presentacion.INVENTARIOS_KARDEX

{
    public partial class INVENTARIO_MENU : Form
    {
        ...
        {
            if (txtbuscarMovimiento.Text == ""  | txtbuscarMovimiento.Text == "")
                {
...
buscar_MOVIMIENTOS_FILTROS();
        ...
        private void INVENTARIO_MENU_Load(object sender, EventArgs e)
        {
            ...
            txtbuscarKardex_movimientos.Text = "";
        ...
        {
            if (txtbuscarKardex_movimientos.Text == "" | txtbuscarKardex_movimientos.Text == "")
            {
